<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button class="filter-item" type="primary" @click="handleDelete"  icon="delete">删除回复消息</el-button>
    ...
    <!-- 表格 -->
    <el-table ref="multipleTable" @selection-change="handleSelectionChange" :data="replyList" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit highlight-current-row  >
         <el-table-column type="selection" width="65">
          ...
          <el-table-column label="回复内容" width="" align="center" >
            <template scope="scope">
              {{scope.row.content}}
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      axios
        .get("http://localhost:9090/reply/selectReplyList", { params: par })
        .then(result => {
          let res = result.data;
          console.log(res);
    ...
    handleDelete() {
      ...
      if (this.multipleSelection.length == 1) {
        ...
        this.$confirm("此操作将永久删除该数据, 是否继续?", "提示", {
          ...
          .then(() => {
            axios
              .delete("http://localhost:9090/reply/deleteReply", {
                params: param
              })
              .then(result => {
                this.$message({
