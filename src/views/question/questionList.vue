<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button class="filter-item" type="primary" @click="handleCreate"  icon="plus">新增问题</el-button>
      <el-button class="filter-item" type="primary" @click="clickEditButton"  icon="edit">编辑问题</el-button>

      <el-button class="filter-item" type="primary" @click="handleDelete"  icon="delete">删除问题</el-button>
    ...
    <!-- 表格 -->
    <el-table ref="multipleTable" @selection-change="handleSelectionChange" :data="questionList" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit highlight-current-row  >
         <el-table-column type="selection" width="65">
          ...
          <el-table-column label="提问者" width="" align="center" >
            <template scope="scope">
              {{scope.row.nike_name}}
            </template>
          </el-table-column>
            ...
            <el-table-column align="center"  label="提问时间" >
                <template scope="scope">
                   <i class="el-icon-time"></i>
    ...
    <el-dialog title="新增问题" :visible.sync="dialogFormAddTeam">
         ...
         <el-form-item label="提问者" style="width: 100%;" required>
                <el-select v-model="temp.questionerid" placeholder="请选择提问者"  style="width: 95%;">
...
export default {
  ...
  methods: {
   ...
   let vm = this;
       ...
       axios.get("http://localhost:9090/question/selectQuestionList",{params:par}).then(result => {
        let res = result.data;
...
clickEditButton(){
      ...
      if(this.multipleSelection.length==1){
        this.dialogFormEditTeam = true;
         ...
         vm.temp.questionerid = this.multipleSelection[0].questionerId;
    ...
    handleEditSubmit(){
        ...
        axios.put('http://localhost:9090/question/updateQuestion',{ 
          id:vm.temp.id,
          teamid:vm.temp.teamid,
          questionerid:vm.temp.questionerid,
    ...
    handleDelete(){
        ...
        this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
           ...
           axios.delete("http://localhost:9090/question/deleteQuestion",{params:param}).then(result =>{
             this.$message({
                type: 'success',
                message: '删除成功!'
              });
    ...
    handleCreateSubmit(){
        ...
        console.log('新增入参：',vm.temp)
           //新增接口
           axios.post('http://localhost:9090/question/addQuestion',JSON.stringify(vm.temp),{
           headers: {
                        'Content-Type': 'application/json;charset=UTF-8'
                    }
           }).then((res)=>{
